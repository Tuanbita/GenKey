...
func main() {
  ...
  client := session.NewTSimpleSessionService_WClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "createSession":
    ...
    argvalue0 := session.NewTUserSessionInfo()
  ...
  case "getSession":
    ...
    value0 := session.TSessionKey(argvalue0)
