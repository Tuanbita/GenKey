...
func encodeToString(privateKey *ecdsa.PrivateKey, publicKey *ecdsa.PublicKey) (string, string) {
...
func decodeToECDSA(pemEncoded string, pemEncodedPub string) (*ecdsa.PrivateKey, *ecdsa.PublicKey) {
...
func test() {
	...
	pubKey_byte := crypto.FromECDSAPub(publicKey)

    encPriv, encPub := encodeToString(privateKey, publicKey)

    fmt.Println("priv: ",encPriv)
    fmt.Println("pub: ",encPub)

    priv2, pub2 := decodeToECDSA(encPriv, encPub)
...
////////// 6fe356d9d99d17ad7447229acf03173ea3c8b2fd0fd9150325f8b7a1dbde8d2a
// privHex:de8fb49e27f70e5a912037230150f95dc5bfb1e5135bc717a109727538cb668d

////////// 04b7a1b84a9c3742aca345475cf96b6445cfec4f072df10f982e0ea75dea888f12de3a081951503451437e6fa3c1fc22d4e4bd4470c2f257f823548413c248893f
